    ...
    return (  
        <>
            <div className='m-0 p-0' style={{'width' : '250px', 'height' : '350px'}}>
                <button className='btn-container btn h-100 w-100 shadow-lg border border-dark border-1 border-opacity-25 rounded p-0 m-0' onClick={()=>{setMain(false)}}>
                    <div className='d-flex flex-column justify-content-start w-100 h-100'>
                        ...
                        <div className='text-container p-0 m-0 w-100 h-100 border-top border-dark border-2 border-opacity-50'>
                            <div className='d-flex flex-column gap-3 justify-content-center align-items-center'>
                                <div className='game-title p-1 py-2 m-0 border-bottom border-dark border-2 border-opacity-50 d-flex align-items-center'>
